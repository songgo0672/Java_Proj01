...
public class ConsoleOutput {
	...
	public static void main(String[] args) {
		// 콘솔에서 다양한 출력 방법 
		//1. System.out.println("");   : 출력후 라인은 개행. 엔터가되냐안되냐
			//문자열을 출력시에는 ""가 들어가야한다.
		...
		System.out.println("2" + "4" );			// 문자열 2와 문자열 4의 연결
		...
		int a = 5;    //정수형 a 변수에 정수값 5를 넣어라
						// =  : =오른쪽의 값을 왼쪽에 넣어라 왼쪽 변수에 값을 할당해라.
						// == :  같다의 의미
		...
		//2. System.out.print("");  : 출력후 라인을 개행 하지않는다.엔터가되냐안되냐
			// \n : 엔터, \t : 탭
		System.out.print("반갑\t");
