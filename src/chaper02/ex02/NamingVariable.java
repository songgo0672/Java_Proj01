...
public class NamingVariable {
	...
	public static void main(String[] args) {
		...
		char a3bcd;		//
		long abcd3;
		//double int;		// 자베에서 사용되는 예약어는 사용할 수 없다.
