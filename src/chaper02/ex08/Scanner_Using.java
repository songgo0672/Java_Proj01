...
//2. Scanner 객체를 import  (ctrl +shif + o)
...
public class Scanner_Using {
	...
	public static void main(String[] args) {
		...
		//3. Scanner import 이후 사용할 변수 선언 : Scanner(콘솔)로 인풋 받아서 저장할 변수 선언.
		...
		name = sc.next();						// next는 콘솔에서 문자열을 받도록 하는것
	    System.out.println("국어점수를 입력 하세요>>>");
	    kor = sc.nextInt();						// nextInt는 콘솔에서 정수를 인풋 받도록
