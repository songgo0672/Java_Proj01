...
public class Break_Controll_Keyword {
	...
	public static void main(String[] args) {
		// break 제어 키워드 : 제어문 (if(생략됨), switch(명시 해야됨), for, while, do while)
		// 		-제어문을 탈출 할때 사용됨
		//1. 단일 loop 문에서 break 탈출 
		for (int i = 0;i<10;i++) {
			System.out.println(i);
			break;				//break를 만나는 순간 제어문 탈출
		}	//0
		System.out.println("===============================");
		for (int i = 0; i < 10; i++) {
			System.out.println(i);
		...
		//		case 2 : 점프해서 한번에 밖의 For문을 탈출하는 경우 ( LABLE )
			...
			System.out.println("==================================================");
		//		case 3 : 점프해서 한번에 밖의 For문으로 탈출하는경우 ( 변수값을 조정해서 탈출하는 경우)
			for(int i = 0 ; i < 5 ; i++) {
				for (int j = 0 ; j < 5; j ++) {
					if(j == 2) {
